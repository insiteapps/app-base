...
abstract class AbstractEnquiryForm extends Form
{
    ...
    {
        $f = new FieldList( TextField::create( 'Name', 'Full name' ), EmailField::create( 'Email', 'Email Address' ), TextField::create( 'Telephone' ), DropdownField::create( 'Country', 'Country of origin' )
                                                                                                                                                                     ->setSource( UtilityManager::CountyList() )
                                                                                                                                                                     ->setEmptyString( "-- Select Country --" )
                                                                                                                                                                     ->setAttribute( 'placeholder', 'Country of origin' ), TextareaField::create( 'Message', 'Message' ) );
